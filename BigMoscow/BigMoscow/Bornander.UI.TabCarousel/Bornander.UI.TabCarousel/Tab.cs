...
namespace Bornander.UI.TabCarousel
{
    public class Tab
    {
        ...
        public Tab(FrameworkElement element, Color color, double depth)
        {
            ...
            boxMesh = Box.CreateBoxMesh(1.1, 2.04, depth, Box.Side.Right | Box.Side.Left | Box.Side.Top | Box.Side.Bottom | Box.Side.Back);
            visualMesh = Box.CreateBoxMesh(1.1, 2.04, depth, Box.Side.Front);
